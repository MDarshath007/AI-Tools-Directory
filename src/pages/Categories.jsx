...
function Categories() {
  ...
  // 2. Matching background & text color classes per category
        ...
        <section className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 text-center sm:text-left">
            ...
            <p className="text-gray-500 text-base sm:text-lg">
              Explore AI tools by category and find the perfect one for your needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {categoriesList.map((category, index) => (
              ...
              >
                {/* Fixed: Access category.colors.bg and category.colors.text */}
                <div
                  className={`p-4 ${category.colors.bg} rounded-full transition-transform duration-200 group-hover:scale-110`}
                >
                  <i className={`${category.icon} ${category.colors.text} text-3xl`}></i>
                </div>
