      ...
      <div className="max-w-7xl mt-10 mx-auto">
        ...
        <div className="flex justify-between items-center my-10 flex-col md:flex-row p-4 sm:p-0">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center border border-gray-200 shadow-sm hover:scale-[1.02] hover:shadow-xl hover:border-sky-500 transition  p-5 rounded-xl gap-5">
